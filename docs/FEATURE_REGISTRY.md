...
| ID   | Feature                                                    | Owner | Status      | Dependencies         | Tests / flag                                  |
| ---- | ---------------------------------------------------------- | ----- | ----------- | -------------------- | --------------------------------------------- |
| F001 | One primary NOW task                                       | Focus | IMPLEMENTED | current focus engine | selection reasons; `commandCenterV1`          |
| F002 | Next two candidates                                        | Focus | IMPLEMENTED | T02                  | deterministic selection; `commandCenterV1`    |
| F003 | Selection reason, duration, deadline, project/goal context | Focus | IMPLEMENTED | F001, A003           | query assertions; `commandCenterV1`           |
| F004 | Start/Done/Snooze/Skip                                     | Focus | IMPLEMENTED | A002, N002           | transitions; `commandCenterV1`                |
| F005 | Cannot do today / Move to Waiting                          | Focus | IMPLEMENTED | A012                 | safe command responses; `commandCenterV1`     |
| F006 | Single Task Focus                                          | Focus | IMPLEMENTED | F001                 | route and session tests; `focusModeV1`        |
| F007 | Flow Timer                                                 | Focus | IMPLEMENTED | F006                 | fixed-clock tests; `focusModeV1`              |
| F008 | Countdown Timer                                            | Focus | IMPLEMENTED | F006                 | fixed-clock tests; `focusModeV1`              |
| F009 | Pomodoro-compatible mode                                   | Focus | IMPLEMENTED | F008                 | mode selection; `focusModeV1`                 |
| F010 | This-or-That and Quick Win                                 | Focus | PARTIAL     | T24                  | deterministic choice query; `commandCenterV1` |
| F011 | Task Jar with eligible-only random selection               | Focus | PARTIAL     | A002                 | injected `RandomSource`; `commandCenterV1`    |
...
| FIN063 | User-facing transfer and card-payment semantics                          | Finance/Application  | IMPLEMENTED | FIN004         | transfer application test; `financeDomain`                                   |
| FIN064 | Manual statement, obligation and payment workflow                        | Finance/Application  | IMPLEMENTED | FIN007, FIN009 | payment application test; `financeDomain`                                    |
...
| FIN015 | Monthly budgets                                                          | Finance              | IMPLEMENTED | FIN003         | ledger-derived actuals; `cashflowPlanning`                                   |
| FIN016 | Category/wallet/account budgets                                          | Finance              | PARTIAL     | FIN015         | allocation UI follows category manager maturity; `cashflowPlanning`          |
| FIN017 | Budget progress and overspending warnings                                | Finance/Trigger      | IMPLEMENTED | FIN015         | deterministic thresholds; `cashflowPlanning`                                 |
| FIN018 | Financial goals and reserve goals                                        | Finance              | IMPLEMENTED | FIN015         | linked/manual balance progress; `cashflowPlanning`                            |
| FIN019 | 7-day cashflow forecast                                                  | Finance              | IMPLEMENTED | FIN003, FIN007 | exact per-currency forecast; `cashflowPlanning`                              |
| FIN020 | 14-day cashflow forecast                                                 | Finance              | IMPLEMENTED | FIN019         | horizon selector; `cashflowPlanning`                                         |
| FIN021 | 30-day cashflow forecast                                                 | Finance              | IMPLEMENTED | FIN019         | horizon selector; `cashflowPlanning`                                         |
| FIN022 | 90-day cashflow forecast                                                 | Finance              | IMPLEMENTED | FIN019         | horizon selector; `cashflowPlanning`                                         |
| FIN023 | ExpectedCashShortfallDetected event                                      | Finance/Events       | IMPLEMENTED | FIN019         | FIN-T15 forecast signal; `financeTriggers`                                   |
...
| FIN026 | Duplicate prevention and confidence explanation                          | Finance              | IMPLEMENTED | FIN025         | external ID/date/amount/reference explanations; `financeReconciliation`      |
...
| FIN046 | FIN-T15 expected cash shortfall                                          | Finance/Trigger      | IMPLEMENTED | FIN023         | forecast signal evaluation; `financeTriggers`                                |
...
| FIN052 | Finance import formats CSV/OFX/QFX/QIF/CAMT                              | Finance/Capture      | IMPLEMENTED | Q008           | bounded CAMT subset; parser fixtures; `financeCapture`                       |
| FIN053 | User confirmation for extracted amount/minimum/due date/account/currency | Finance/Capture      | IMPLEMENTED | FIN010         | proposal confirmation boundary; `financeCapture`                             |
| FIN054 | FinancialDocumentExtractor and FinancialCaptureProposal                  | Finance/Capture      | IMPLEMENTED | FIN010         | label-first PDF text proposal; `financeCapture`                              |
