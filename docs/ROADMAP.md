...
14. Finance capture, import, reconciliation **(Phase 14B: proposal-first PDF text extraction; CSV/OFX/QFX/QIF and bounded CAMT import adapters; image OCR remains explicitly partial without a local engine)**
